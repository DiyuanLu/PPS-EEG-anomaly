...
for LOO_animal in LOO_animals:
    if LOO:
        train_files, valid_files = get_data_files_LOO(data_path, train_valid_split=True,
                                                      train_percentage=0.75, num2use=n_files2use,
                                                       LOO_ID = LOO_animal)
    
    else:
        train_files, valid_files = get_train_val_files(data_path, train_valid_split=True, train_percentage=0.8, num2use=n_files2use)
